...
const { findPublishWork, findPreviewWork } = require("../controller/works.js");
const {
  propsToStyle,
  getLegoComponentsHtml,
} = require("../controller/render.js");
const getWxConf = require("../middlewares/getWxConf");
const { DEFAULT_SHARE_IMG } = require("../config/constant.js");
...
async function renderPage(ctx, work, pageType) {
  ...
  console.log("componentsHtml", componentsHtml);
  // 组件的事件
  const eventInfoList = [];
  ...
  console.log("eventInfoList", eventInfoList);
